...
export default function Landing() {
  ...
  const testimonials = [
    ...
    { name: "Emily Rodriguez", role: "Social Media Manager", quote: "Essential for protecting our brand reputation. Fast, accurate, and reliable.", avatar: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150&h=150&fit=crop&crop=face", color: "from-cyan-500 to-teal-500" },
  ];
  ...
  const pricingPlans = [
    ...
    { name: "Pro", price: "$29", period: "/month", desc: "For professionals", features: ["Unlimited analyses", "Advanced detection", "Priority support", "Results in 1 minute", "API access", "Custom reports"], popular: true, color: "from-[#0891b2] to-[#06b6d4]" },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 text-slate-900 overflow-x-hidden font-sans">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute bottom-40 left-20 w-2 h-2 rounded-full bg-cyan-500/40 animate-bounce" style={{ animationDuration: '5s', animationDelay: '0.8s' }}></div>
        ...
        {/* Geometric Shapes */}
        <div className="absolute top-1/4 left-[10%] w-16 h-16 border-2 border-cyan-500/20 rotate-45 animate-spin" style={{ animationDuration: '20s' }}></div>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            {user ? (
              ...
              <>
                ...
                <Link to="/register" className="px-4 sm:px-5 py-2 sm:py-2.5 rounded-xl bg-gradient-to-r from-[#0891b2] to-[#06b6d4] hover:from-[#06b6d4] hover:to-[#22d3ee] text-xs sm:text-sm font-semibold transition shadow-lg shadow-cyan-600/25 hover:shadow-cyan-600/40">
                  Get Started
                </Link>
              </>
            )}
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 pt-12 sm:pt-16 lg:pt-20 pb-20 sm:pb-28 lg:pb-32">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="text-center lg:text-left px-0 lg:px-0">
            <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-cyan-500/10 border border-cyan-500/20 text-cyan-400 text-xs sm:text-sm font-medium mb-4 sm:mb-6 animate-fade-in-up">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight mb-4 sm:mb-6 leading-[1.05] text-slate-800 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
              Detect
              <span className="block bg-gradient-to-r from-[#0891b2] via-[#06b6d4] to-[#22d3ee] bg-clip-text text-transparent">
                Deepfake
              </span>
              Instantly
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            {steps.map((step, i) => (
              <div key={i} className="relative text-center">
                {i < steps.length - 1 && (
                  <div className="hidden md:block absolute top-16 left-[60%] w-[80%] h-0.5 bg-gradient-to-r from-cyan-500/50 to-transparent"></div>
                )}
                <div className="relative p-6 sm:p-8 rounded-2xl sm:rounded-3xl bg-white border border-slate-200 hover:border-cyan-500/30 transition-all duration-300 shadow-sm">
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2 w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gradient-to-r from-[#0891b2] to-[#06b6d4] flex items-center justify-center text-lg sm:text-xl font-bold shadow-lg z-10 text-white">
                    {step.num}
                  </div>
                  <div className="mt-4 sm:mt-6 mb-4 sm:mb-6">
                    <div className="w-16 sm:w-20 h-16 sm:h-20 mx-auto rounded-xl sm:rounded-2xl bg-gradient-to-br from-cyan-500/20 to-blue-500/20 flex items-center justify-center">
                      <svg className="w-8 sm:w-10 h-8 sm:h-10 text-cyan-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {user && (
        <section id="detect" className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16 lg:py-20 scroll-mt-20">
          <div className="relative rounded-2xl sm:rounded-3xl bg-white border border-slate-200 shadow-xl p-6 sm:p-8 md:p-10 lg:p-12">
            <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#0891b2] via-[#06b6d4] to-[#22d3ee]"></div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-start max-w-2xl mx-auto mb-4 sm:mb-6">
              <label className="flex-1 cursor-pointer w-full">
                <span className="flex items-center gap-2 sm:gap-3 px-4 sm:px-6 py-3 sm:py-5 rounded-xl sm:rounded-2xl bg-slate-100 border-2 border-dashed border-slate-300 hover:border-cyan-500/50 hover:bg-cyan-50 transition-all">
                  <svg className="w-6 sm:w-8 h-6 sm:h-8 text-cyan-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" /></svg>
            ...
            {result && (
              <div className="mt-6 sm:mt-8 p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-slate-50 border border-slate-200">
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 sm:mb-6 gap-3">
                  <h3 className="text-lg sm:text-xl font-bold text-cyan-700">Analysis Complete</h3>
                  <span className="px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-cyan-100 text-cyan-700 text-xs sm:text-sm font-medium">{isImage(file) ? "Image" : "Video"} Analysis</span>
                </div>
      ...
      <section id="faq" className="relative z-10 py-24 bg-slate-100">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="space-y-4">
            {faqs.map((faq, i) => (
              <div key={i} className="group p-6 rounded-2xl bg-white border border-slate-200 hover:border-cyan-500/30 transition-all duration-300">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-cyan-500/20 to-blue-500/20 flex items-center justify-center text-cyan-600 flex-shrink-0">?</div>
                  <div>
      ...
      <section id="pricing" className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-20 lg:py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          {pricingPlans.map((plan, i) => (
            <div key={i} className={`relative p-5 sm:p-6 lg:p-8 rounded-2xl sm:rounded-3xl border-2 transition-all duration-300 hover:-translate-y-2 ${plan.popular ? 'border-cyan-500 bg-white shadow-xl shadow-cyan-600/20' : 'border-slate-200 bg-white hover:border-slate-300'}`}>
              {plan.popular && <div className="absolute -top-3 sm:-top-4 left-1/2 -translate-x-1/2 px-3 sm:px-4 py-1 rounded-full bg-gradient-to-r from-[#0891b2] to-[#06b6d4] text-white text-xs sm:text-sm font-semibold">Most Popular</div>}
              ...
              <ul className="space-y-2 sm:space-y-3 mb-6 sm:mb-8">
                {plan.features.map((feature, j) => (
                  <li key={j} className="flex items-center gap-2 sm:gap-3 text-slate-600 text-sm sm:text-base">
                    <svg className="w-4 sm:w-5 h-4 sm:h-5 text-cyan-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                    <span className="text-xs sm:text-sm">{feature}</span>
                  </li>
                ))}
              </ul>
              <button className={`w-full py-3 sm:py-4 rounded-xl sm:rounded-xl font-semibold transition transform hover:scale-105 ${plan.popular ? 'bg-gradient-to-r from-[#0891b2] to-[#06b6d4] text-white shadow-lg text-sm sm:text-base' : 'bg-slate-100 text-slate-700 hover:bg-slate-200 text-sm sm:text-base'}`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {teamMembers.map((member, i) => (
              <div key={i} className="group p-5 sm:p-6 rounded-2xl sm:rounded-3xl bg-white border border-slate-200 hover:border-cyan-500/30 transition-all duration-300 hover:-translate-y-2">
                ...
                <div className="text-center">
                  ...
                  <p className="text-cyan-600 font-medium mb-2 sm:mb-3 text-sm sm:text-base">{member.role}</p>
      ...
      <section id="partners" className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-20 lg:py-24">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-6 lg:gap-8">
          {partners.map((partner, i) => (
            <div key={i} className="group p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-white border border-slate-200 hover:border-cyan-500/30 transition-all duration-300 flex items-center justify-center hover:-translate-y-1">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            {blogPosts.map((post, i) => (
              <div key={i} className="group rounded-2xl sm:rounded-3xl bg-white border border-slate-200 overflow-hidden hover:border-cyan-500/30 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
                ...
                <div className="p-4 sm:p-6">
                  ...
                  <h3 className="text-base sm:text-lg font-bold text-slate-800 mb-2 sm:mb-3 group-hover:text-cyan-600 transition-colors">{post.title}</h3>
                  <a href={post.link} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 sm:gap-2 text-cyan-600 font-medium hover:gap-2 sm:hover:gap-3 transition-all text-sm">
          ...
          <form className="p-6 sm:p-8 rounded-2xl sm:rounded-3xl bg-white border border-slate-200 shadow-xl">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-4 sm:mb-6">
              <div>
                ...
                <input type="text" className="w-full px-3 sm:px-4 py-2.5 sm:py-3 rounded-xl border border-slate-200 focus:border-cyan-500 focus:ring-2 focus:ring-cyan-500/20 outline-none transition text-sm sm:text-base" placeholder="John" />
              </div>
              <div>
                <label className="block text-slate-700 font-medium mb-2 text-sm sm:text-base">Last Name</label>
                <input type="text" className="w-full px-3 sm:px-4 py-2.5 sm:py-3 rounded-xl border border-slate-200 focus:border-cyan-500 focus:ring-2 focus:ring-cyan-500/20 outline-none transition text-sm sm:text-base" placeholder="Doe" />
              </div>
            </div>
            <div className="mb-4 sm:mb-6">
              <label className="block text-slate-700 font-medium mb-2 text-sm sm:text-base">Email</label>
              <input type="email" className="w-full px-3 sm:px-4 py-2.5 sm:py-3 rounded-xl border border-slate-200 focus:border-cyan-500 focus:ring-2 focus:ring-cyan-500/20 outline-none transition text-sm sm:text-base" placeholder="john@example.com" />
            </div>
            <div className="mb-4 sm:mb-6">
              <label className="block text-slate-700 font-medium mb-2 text-sm sm:text-base">Message</label>
              <textarea className="w-full px-3 sm:px-4 py-2.5 sm:py-3 rounded-xl border border-slate-200 focus:border-cyan-500 focus:ring-2 focus:ring-cyan-500/20 outline-none transition resize-none h-24 sm:h-32 text-sm sm:text-base" placeholder="How can we help you?"></textarea>
            </div>
            <button type="submit" className="w-full py-3 sm:py-4 rounded-xl sm:rounded-xl bg-gradient-to-r from-[#0891b2] to-[#06b6d4] text-white font-semibold hover:from-[#06b6d4] hover:to-[#22d3ee] transition transform hover:scale-[1.02] shadow-lg shadow-cyan-600/25 text-sm sm:text-base">
              Send Message
            </button>
          </form>
        </div>
      ...
      <section className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 py-16 sm:py-20 lg:py-24">
        <div className="relative rounded-2xl sm:rounded-3xl bg-gradient-to-br from-[#0891b2]/20 via-[#06b6d4]/15 to-[#22d3ee]/20 border border-slate-200 p-8 sm:p-12 lg:p-16 xl:p-20 text-center overflow-hidden shadow-xl">
          <div className="absolute top-0 left-1/4 w-48 sm:w-56 lg:w-72 h-48 sm:h-56 lg:h-72 bg-cyan-400/20 rounded-full blur-2xl sm:blur-3xl"></div>
          ...
          <div className="relative">
            ...
            {user ? (
              <a href="#detect" className="inline-flex items-center justify-center gap-2 sm:gap-3 px-8 sm:px-10 py-4 sm:py-5 rounded-xl sm:rounded-2xl bg-gradient-to-r from-[#0891b2] to-[#06b6d4] text-white font-bold text-sm sm:text-lg hover:from-[#06b6d4] hover:to-[#22d3ee] transition transform hover:scale-105 shadow-xl">
                Start Detection Now
              </a>
            ) : (
              <Link to="/register" className="inline-flex items-center justify-center gap-2 sm:gap-3 px-8 sm:px-10 py-4 sm:py-5 rounded-xl sm:rounded-2xl bg-gradient-to-r from-[#0891b2] to-[#06b6d4] text-white font-bold text-sm sm:text-lg hover:from-[#06b6d4] hover:to-[#22d3ee] transition transform hover:scale-105 shadow-xl">
                Create Free Account
                <svg className="w-5 sm:w-6 h-5 sm:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" /></svg>
              </Link>
            )}
